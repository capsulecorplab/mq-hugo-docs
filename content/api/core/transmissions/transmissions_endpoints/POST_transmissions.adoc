:sampledir: ../transmissions_samples
...
| token | string | No | The unique identifier of the transmission. <br> <br> If you do not include a token, the system will generate one automatically. This token is necessary for use in other API calls. <b>This value cannot be updated</b>. | 36 char max 
...
| *custom\_name\_01*<br>*custom\_name\_02* <br> <br> ... <br> <br> *custom\_name\_20* <br> <br> (255 char max per name) | string | No | Custom data transmitted with the card data. You can define the names and values of up to 20 fields, for example:<br><br><span class="code-font">"metadata": {<br>&nbsp;&nbsp;"my\_name\_1": "my\_value\_1",<br>&nbsp;&nbsp;"my\_name\_2": "my\_value\_2"<br>&nbsp;&nbsp;}</span> | Up to 20 name-value pairs. <br> <br> 255 char max per name; 255 char max per value.
|===
...
[source,json]
include::{sampledir}/create_and_send_transmission_request.json[]

=== Sample response body

[source,json]
include::{sampledir}/create_and_send_transmission_response.json[]